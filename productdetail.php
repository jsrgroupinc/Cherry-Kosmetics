	...
	<script>
		...
		function loader(){
			...
			var pid=getParameterByName("ProductId"),
				js = {"ProductId":pid},
				params="req="+JSON.stringify(js),
				subcats = ["CategoryId","Name","MCategoryId","MCategoryName"],
				prodFields = new Array("ProductId","ProductName","BrandName","Description","ImagePath","QuantityPerUnit","UnitPrice","UnitsInStock");
			getRequest(params,5,PROD_BY_ID_URL,"","dcProductresp",prodFields);
	...
	<section id="mainContent" class="full-bleed vertical">
		<article id="categoriesBanner" class="mid white-back horizontal-reveresed web-section shadowed">
			<div class="vertical catban-sec">
				<h4 class="page-title white pink-back shadowed padded full-bleed"><div class="dashed-top dashed-bottom" id="allTitle"></div></h4>
				<ul>
		...
		<article class="big-padded mid horizontal patterned web-section shadowed">
			<div id="prodgallery" class="vertical flexed">
				
			</div>
			<div id="proddetails" class="flex-start vertical flexed"></div>
		</article>
	</section>
