...
<head>
	...
	<script>
		...
		function loader(){
			...
			fetchCat("#subcat");
			//var params = "req=" + JSON.stringify({ "CategoryId": parseInt( getParameterByName("catid") ), "PageNumber":1, "PageSize":20 });
			//getRequest(params,2,QUERY_PROD_URL,"#subcat","dcProductresp","ProductId");
			$("#allTitle").html(getParameterByName("catname"));
			showSubCat(2,SUBCAT_URL,"#categSubs","BECategory",subcats,getParameterByName("catid"));
...
<body onload="wait()">
	...
	<section id="mainContent" class="full-bleed vertical">
		<article id="categoriesBanner" class="mid white-back horizontal-reveresed web-section shadowed">
			<div class="vertical catban-sec">
				<h4 class="page-title white patterned-ribbon shadowed padded full-bleed"><div class="dashed-bottom" id="allTitle"></div></h4>
				<ul>
					<li><a href="#" id="allLink" class="pink-text"></a></li>
				</ul>
				<ul id="categSubs">
					<img class="loader" src="css/images/loading.gif">
				</ul>
			</div>
			<div class="vertical catban-sec">
				<div><img src="css/images/catbanner.jpg"></div>
			</div>
		</article>
		<article class="mid white-back-subtle vertical web-section shadowed">
			<div class="horizontal-not-resp">
				<h4 id="paginationTitle" class="page-panel red-text white-back"></h4>
				<div class="horizontal-not-resp page-holder page-panel flex-end"></div>
			</div>
			<div id="itemGrid" class="vertical"><img class="loader" src="css/images/loading.gif"></div>
			<div class="horizontal-not-resp">
				<h4 class="page-panel"></h4>
				<div class="horizontal-not-resp page-holder page-panel flex-end"></div>
			</div>
		</article>
	</section>
