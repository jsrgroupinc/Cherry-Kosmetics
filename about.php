...
<div class="sparkley"></div>
	...
	<section id="mainContent" class="full-bleed vertical">
		...
		<article class="mid full-bleed horizontal flex-center">
			<div class = "grid horizontal flexed">
				<div class = "zero radius pink-back flexed bordered" id = "box1">
					<div id = "chat-holder" class = "bordered">
						<h4>CHAT SUPPORT</h4>
					</div>
					<div class = "zero radius white-back flexed" id = "box2">
					 g
					</div>
				</div>
			</div>
